...
static U8 ControlAssignmentsCreateItems(WM_HWIN hParent)
{
	...
	hControlAssignmentsItems[CONTROLASSIGNMENTS_LEARN] = BUTTON_CreateAsChild(x,y,bmVOICE_LEARN_UN.XSize,bmVOICE_LEARN_UN.YSize,hParent,CONTROLASSIGNMENTS_ID_LEARN,WM_CF_SHOW|WM_CF_MEMDEV);
	BUTTON_SetFocussable(hControlAssignmentsItems[CONTROLASSIGNMENTS_LEARN],0);
	BUTTON_SetBitmap(hControlAssignmentsItems[CONTROLASSIGNMENTS_LEARN],BUTTON_CI_UNPRESSED,&bmVOICE_LEARN_UN);
	BUTTON_SetBitmap(hControlAssignmentsItems[CONTROLASSIGNMENTS_LEARN],BUTTON_CI_PRESSED,&bmVOICE_LEARN_SE);
