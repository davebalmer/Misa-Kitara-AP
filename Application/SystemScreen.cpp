...
static U8 SystemCreateItems(WM_HWIN hParent)
{
	...
	x += bmSM_WF_UN.XSize + 8;
	hSystemItems[SYSTEM_ENABLESCENESLABEL] = TEXT_CreateAsChild(x,y, SYSTEM_LABEL_SIZE_X, bmSM_WF_UN.YSize,hParent,SYSTEM_ID_TEXT,WM_CF_SHOW|WM_CF_MEMDEV,"Scenes (fret 24)", GUI_TA_VCENTER);
