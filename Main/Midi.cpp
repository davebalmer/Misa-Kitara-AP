...
//std::cout << "note on " << (unsigned int) output << ": " << (unsigned int) note << " channel: " << (unsigned int) channel << " port channel: " << (unsigned int) chan << " velocity: " << (unsigned int) velocity << "." << std::endl << std::flush;
}
...
//std::cout << "note off " << (unsigned int) output << ": " << (unsigned int) note << "." << std::endl << std::flush;
}
