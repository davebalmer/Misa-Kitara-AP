...
**********************************************************************
*/
unsigned char DisplayBuffer[256][960];
...
#define DWORDS_PER_LINE  (LCD_XSIZE / PIXELS_PER_DWORD)
...
U32 LCD_READ_MEM(U32 Off)
{  int y=Off/DWORDS_PER_LINE+12;
   int x=(Off%DWORDS_PER_LINE)*6;
   U32 r,g,b,r1,g1,b1,c;
   
   g1=(U32)(~(DisplayBuffer[y][x+1])&0xf8);
   b1=(U32)(~(DisplayBuffer[y][x+2])&0xfc);
   r1=(U32)(~(DisplayBuffer[y][x+3])&0xf8);
   
   g=(U32)(~(DisplayBuffer[y][x+4])&0xf8);
   b=(U32)(~(DisplayBuffer[y][x+5])&0xfc);
   r=(U32)(~(DisplayBuffer[y][x+6])&0xf8);
   
   c=b<<24|g<<19|r<<13|b1<<8|g1<<3|r1>>3;
   
 
   return c;
}
LCD_WRITE_MEM(U32 Off,U32 Data)
{
   int y=Off/DWORDS_PER_LINE+12;
   int x=(Off%DWORDS_PER_LINE)*6;
   ...
   DisplayBuffer[y][x+4] =~g|0x07;
   DisplayBuffer[y][x+5] =~b|0x03;
   DisplayBuffer[y][x+6] =~r|0x07;	
   ...
   DisplayBuffer[y][x+1]   =~g|0x07;
   DisplayBuffer[y][x+2]   =~b|0x03;
   DisplayBuffer[y][x+3]   =~r|0x07;		
}
